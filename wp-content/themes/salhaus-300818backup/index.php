	...
	<div id="project-content">
		<div class="category-bar">
			...
			<ul class="category-list cat-list">
				<li class="item current"><a href="<?php echo site_url(); ?>/projects/">All</a></li>
				<?php 
		...
		<ul class="category-list-sp sp cat-list">
		 ...
		 <ul class="category">
			<?php 
				...
				$args = array( 'post_type' => 'post', 'posts_per_page' => 3  , 'category__not_in' => array($category_id),'pagination'=> true, 'paged' => $paged,);
				query_posts($args);
			...
			<?php if ( $the_query->have_posts() ) : ?>
				...
				<li id="<?php echo $cat_slug; ?>" style="background-image:url(<?php $image_url = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'large'); echo $image_url[0]; ?>);">
					<p>
